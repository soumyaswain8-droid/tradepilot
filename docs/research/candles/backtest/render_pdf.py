...
HTML = os.path.join(REP, "candlestick-lessons-backtest.html")
PDF = os.path.join(REP, "candlestick-lessons-backtest.pdf")
QA = os.path.join(REP, "qa")
...
async def render():
    ...
    await page.goto(f"file://{HTML}", waitUntil="networkidle0", timeout=60000)
