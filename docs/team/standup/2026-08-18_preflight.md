# Preflight — 2026-08-18

_Generated 2026-08-18 08:50:13_  ·  exit=1

```
[36m═══════════════════════════════════════════════════════[0m
[36m  Monday Self-Test — 2026-08-18 08:50:01[0m
[36m═══════════════════════════════════════════════════════[0m
...
[36m— 1b. Disk headroom —[0m
  [32m✓[0m free disk >= 5 GB (session needs ~2 GB, engines write continuously)
...
[36m— 5. ML model + Sarathi gate —[0m
  ...
  [31m✗[0m MLOps IC gate allows current model (CEO override active) [31mFAIL[0m
      ...
      Telegram send failed: HTTPSConnectionPool(host='api.telegram.org', port=443): Max retries exceeded with url: /bot8793449943:AAFPQtV32rkIkcR4pCxAb2l6BJczQ4SXfi8/sendMessage (Caused by NewConnectionError('<urllib3.connection.HTTPSConnection object at 0x11a72d350>: Failed to establish a new connection: [Errno 8] nodename nor servname provided, or not known'))
  [31m✗[0m CEO override has not expired                  [31mFAIL[0m
      FAIL: override expired on 2026-07-25 (today=2026-08-18)
...
[36m— 9. Pending LLM-agent tasks —[0m
    3 pending LLM-agent task(s):
      - alpha-hunter         marked 2026-08-14T16:00:04+05:30: Weekly IC + feature drift audit
      - architect            marked 2026-08-16T19:05:05+05:30: Sprint review + next week planning
      - competitive-intel    marked 2026-08-16T19:00:01+05:30: Weekly Qlib/FinRL/arxiv scan

[36m═══════════════════════════════════════════════════════[0m
  [32mPASS: 25[0m   [33mWARN: 2[0m   [31mFAIL: 3[0m   (total: 30)
