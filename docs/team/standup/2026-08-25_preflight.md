...
_Generated 2026-08-25 08:50:13_  ·  exit=1

```
[36m═══════════════════════════════════════════════════════[0m
[36m  Monday Self-Test — 2026-08-25 08:50:01[0m
[36m═══════════════════════════════════════════════════════[0m
...
[36m— 5. ML model + Sarathi gate —[0m
  ...
  [31m✗[0m MLOps IC gate allows current model (CEO override active) [31mFAIL[0m
      ...
      Telegram send failed: HTTPSConnectionPool(host='api.telegram.org', port=443): Max retries exceeded with url: /bot8793449943:AAFPQtV32rkIkcR4pCxAb2l6BJczQ4SXfi8/sendMessage (Caused by NewConnectionError('<urllib3.connection.HTTPSConnection object at 0x1229cc790>: Failed to establish a new connection: [Errno 8] nodename nor servname provided, or not known'))
  [31m✗[0m CEO override has not expired                  [31mFAIL[0m
      FAIL: override expired on 2026-07-25 (today=2026-08-25)
