...
NIFTY_50 = [
    ...
    "ONGC.NS", "NTPC.NS", "POWERGRID.NS", "M&M.NS", "TMPV.NS",
...
NIFTY_NEXT_50 = [
    ...
    "MAXHEALTH.NS", "UNITDSPR.NS", "MOTHERSON.NS", "MUTHOOTFIN.NS", "NAUKRI.NS",
...
NIFTY_200_EXTRA = [
    ...
    "GLAND.NS", "GMRAIRPORT.NS", "GODREJPROP.NS", "GSPL.NS", "HDFCAMC.NS",
    "HINDPETRO.NS", "HONAUT.NS", "IDFCFIRSTB.NS", "IEX.NS", "INDIANB.NS",
    "INDUSTOWER.NS", "IREDA.NS", "JKCEMENT.NS", "JSL.NS", "JUBLFOOD.NS",
    "KALYANKJIL.NS", "KEI.NS", "KPITTECH.NS", "LTF.NS", "LAURUSLABS.NS",
    ...
    "ETERNAL.NS", "ZYDUSLIFE.NS", "PAYTM.NS", "NYKAA.NS", "POLICYBZR.NS",
]
...
NIFTY_500_EXTRA = [
    ...
    "IIFL.NS", "360ONE.NS", "JMFINANCIL.NS", "KARURVYSYA.NS", "KFINTECH.NS",
    ...
    "ROUTE.NS", "RVNL.NS", "TANLA.NS", "TTML.NS", "ZENSARTECH.NS",
    # Pharma & Healthcare
    "AARTIDRUGS.NS", "AARTIIND.NS", "APOLLOTYRE.NS", "ASTRAZEN.NS", "ATUL.NS",
    "BIRLACORPN.NS", "ZYDUSLIFE.NS", "ERIS.NS", "GLENMARK.NS", "GRANULES.NS",
    ...
    "ARE&M.NS", "APLAPOLLO.NS", "BHARATFORG.NS", "CEATLTD.NS", "CRAFTSMAN.NS",
    "ENDURANCE.NS", "EXIDEIND.NS", "FIVESTAR.NS", "GABRIEL.NS", "GREENPANEL.NS",
    "JBMA.NS", "KIRLOSENG.NS", "CIEINDIA.NS", "UNOMINDA.NS", "MOTHERSON.NS",
    ...
    "MOIL.NS", "NATIONALUM.NS", "NATIONALUM.NS", "NMDC.NS", "RATNAMANI.NS",
    "SAIL.NS", "VEDL.NS", "WELCORP.NS",
    # Cement & Building Materials
    "AMBUJACEM.NS", "BSOFT.NS", "DALBHARAT.NS", "HEIDELBERG.NS", "INDIACEM.NS",
    "JKCEMENT.NS", "JKLAKSHMI.NS", "NUVOCO.NS", "ORIENTCEM.NS", "PRSMJOHNSN.NS",
    "RAMCOCEM.NS", "SHREECEM.NS", "STARCEMENT.NS", "ULTRACEMCO.NS",
    # Energy & Power
    "ADANIENSOL.NS", "ADANIGREEN.NS", "CESC.NS", "GIPCL.NS", "GPPL.NS",
    "GUJGASLTD.NS", "IGL.NS", "IREDA.NS", "JSWENERGY.NS", "JINDALSTEL.NS",
    ...
    "SPICEJET.NS", "TCI.NS", "TIINDIA.NS", "VRLLOG.NS",
    # Miscellaneous
    ...
    "SOLARINDS.NS", "SWIGGY.NS", "TATAINVEST.NS", "VAIBHAVGBL.NS", "ETERNAL.NS",
]
...
NIFTY_AUTO = [
    "TMPV.NS", "M&M.NS", "MARUTI.NS", "BAJAJ-AUTO.NS", "EICHERMOT.NS",
...
NIFTY_METAL = [
    ...
    "APLAPOLLO.NS", "RATNAMANI.NS", "MOIL.NS", "NATIONALUM.NS", "WELCORP.NS",
]
...
MF_PROXIES = [
    ...
    "360ONE.NS",     # IIFL Wealth Management
...
FNO_ACTIVE = [
    ...
    "TMPV.NS", "ITC.NS", "BHARTIARTL.NS", "HCLTECH.NS", "MARUTI.NS",
    ...
    "BEL.NS", "HAL.NS", "JINDALSTEL.NS", "TRENT.NS", "ETERNAL.NS",
